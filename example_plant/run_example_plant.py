...
def run_example_plant(run_pre_iron=True, ore=None, tech=None, location=[45.0, -90.0]):
    ...
    save_pre_iron = True # Output pre-green iron must be saved once before save_pre_iron can be set to False
    ...
    if run_new:
        config = GreenHeartSimulationConfig(
            ...
            run_pre_iron=run_pre_iron,
            save_pre_iron=save_pre_iron,
            pre_iron_fn=output_filepath + filename + "_pre_iron",
            iron_modular=False,
            incentive_option=1,
